...
# ===================================================================
class ansatz_cls:
  def __init__(self, ansatz_tp, Nlayers, Nq, rot=None):
    self.ansatz = []
    ...
    if ansatz_tp == 0:
      ...
      for ilayer in range(Nlayers):
        for layer in layer_rot:
          self.ansatz.append(layer)

        self.ansatz.append(layer_ent1)
        self.ansatz.append(layer_ent2)
    ...
    self.nparams = sum([layer.get_num_params() for layer in self.ansatz])
